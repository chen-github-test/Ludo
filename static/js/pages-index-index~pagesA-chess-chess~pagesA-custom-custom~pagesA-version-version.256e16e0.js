                        ...
                        ? t(
                            ...
                            [
                              i._t("right", [
                                i.rightIcon
                                  ? t("u-icon", {
                                      attrs: { name: i.rightIcon, size: "20" },
                                    })
                                  : i._e(),
                                i.rightText
                                  ? t(
        ...
        c = {
          ...
          computed: {
            uClasses: function () {
              var i = [];
              return (
                i.push(this.customPrefix + "-" + this.name),
                this.color &&
        ...
        u = {
          ...
          computed: {
            style: function () {
              var i = {};
              return (
                (i.height = uni.$u.addUnit(uni.$u.sys().statusBarHeight, "px")),
                ...
                ? t(
                    "v-uni-text",
                    {
                      ...
                      style: {
                        ...
                        marginLeft:
                          "right" == i.labelPos ? i.$u.addUnit(i.space) : 0,
                        marginTop:
                          "bottom" == i.labelPos ? i.$u.addUnit(i.space) : 0,
                        marginRight:
                          "left" == i.labelPos ? i.$u.addUnit(i.space) : 0,
                        marginBottom:
                          "top" == i.labelPos ? i.$u.addUnit(i.space) : 0,
                      },
                    },
                    [i._v(i._s(i.label))]
                  )
